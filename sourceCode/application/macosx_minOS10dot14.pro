#-------------------------------------------------
#
# Stackprof v1.00 ; Qt project file for Mac target (10.14 and above)
#
#-------------------------------------------------
...
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/fmt-7.1.0/include

INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/oiio-RB-2.1/src/include
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/oiio-RB-2.1/macosbuild27oct/include

LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/oiio-RB-2.1/macosbuild27oct/lib/libOpenImageIO.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/fmt-7.1.0/28oct/libfmt.a

#openexr header installed here:
INCLUDEPATH += "/usr/local/include/"

INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/IlmBase/Imath/
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/config/ #for IlmBaseConfig.h
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/IlmBase/Iex/ #for IexBaseExc.h
DEPENDPATH  += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/IlmBase/Imath/

LIBS += -lz -ldl

#static lib linking:
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/Half/libHalf-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/OpenEXR/IlmImfUtil/libIlmImfUtil-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/OpenEXR/IlmImf/libIlmImf-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/IlmThread/libIlmThread-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/Iex/libIex-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/Imath/libImath-2_4.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/openImageIO/openexr_recomp1605/macosbuild27oct1/IlmBase/IexMath/libIexMath-2_4.a

LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_filesystem.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_system.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_thread.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_chrono.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_date_time.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/boost170installhere27oct/lib/libboost_atomic.a
...
LIBS += -L$$INPRO__THIRD_PARTY_LIBS_ROOT/libtiff-master/build27oct2020/libtiff -ltiff

#----------------
#GSL
#----------------
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/gnugsl/gsl-2.6
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/gnugsl/gsl-2.6/.libs/libgsl.a
LIBS += $$INPRO__THIRD_PARTY_LIBS_ROOT/gnugsl/gsl-2.6/cblas/.libs/libgslcblas.a
...
#PROJ:
#----------------
INCLUDEPATH += $$INPRO__THIRD_PARTY_LIBS_ROOT/4libs_geoTogether/proj/proj-6.3.0/src

LIBS += -L$$INPRO__THIRD_PARTY_LIBS_ROOT/4libs_geoTogether/proj/proj-6.3.0/build27oct2020/lib -lproj

#app build made using
# - OS X 10.15.6
# - XCode 11.3 (10.15 SDK)
# - Qt 5.14.2 (x86_64-little_endian-lp64 shared (dynamic) release build; by Clang 10.0.0 (clang-1000.11.45.5) (Apple)) on "cocoa"
#     OS: macOS 10.15 [darwin version 19.6.0]
#     Architecture: x86_64; features: SSE2 SSE3 SSSE3 SSE4.1 SSE4.2 AVX AVX2


#weak linking
#set deployment target as 10.14  (default deployment target for this Qt version is 10.12) 
...
\
    ...
    logic/model/imageScene/customgraphicsscene_usingTPDO.h \ #_withLoadByThread
