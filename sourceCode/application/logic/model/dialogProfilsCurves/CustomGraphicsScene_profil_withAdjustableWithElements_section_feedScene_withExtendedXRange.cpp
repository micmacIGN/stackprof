...
bool CustomGraphicsScene_profil::feedScene_withExtendedXRange(
    ...
    if (!_CGItemDblSidesXAdjWithCompLines_mainMeasure) {
        ...
        qDebug() << __FUNCTION__  << "3) before #482";
        //direct forward:
        ...
        qDebug() << __FUNCTION__  << "3) after #486";
    }
    ...
    qDebug() << __FUNCTION__ << "bAlignWithOtherGraphics : " << " throughAllScene_left_pixelDim: " << throughAllScene_left_pixelDim;
    qDebug() << __FUNCTION__ << "bAlignWithOtherGraphics : " << " throughAllScene_right_pixelDim: " << throughAllScene_right_pixelDim;

    QRectF sceneRectFfromOutside_pixelDim;
    sceneRectFfromOutside_pixelDim.setLeft(throughAllScene_left_pixelDim);
    sceneRectFfromOutside_pixelDim.setRight(throughAllScene_right_pixelDim);
    sceneRectFfromOutside_pixelDim.setHeight(_sceneRectF_areaOfLayerWhenAlone_pixelDim.height());

    _forResizeComputation_sameWidth._sceneRectF = sceneRectFfromOutside_pixelDim;
    _forResizeComputation_sameWidth._wPixelSpaceAtLeft = wPixelSpaceAtLeft;
    _forResizeComputation_sameWidth._wPixelSpaceAtRight = wPixelSpaceAtRight;
